...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getLoggerService()
    {
        ...
        $b = new \Zend\Log\Writer\Stream('/Users/ben/Sites/symfonymeeting/app/logs/dev.log');
        $b->addFilter($a);
...
'));
    ...
    {
        require_once '/Users/ben/Sites/symfonymeeting/vendor/swiftmailer/lib/swift_init.php';
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $this->scopedServices['request']['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('/Users/ben/Sites/symfonymeeting/app/cache/dev/profiler.db', 86400), $a);
    ...
    {
        return $this->services['router.cached'] = new \Symfony\Bundle\FrameworkBundle\Routing\CachedRouter('/Users/ben/Sites/symfonymeeting/app/cache/dev', 'appdevUrlMatcher', 'appdevUrlGenerator');
    }
    ...
    {
        return $this->services['router.real'] = new \Symfony\Component\Routing\Router(new \Symfony\Bundle\FrameworkBundle\Routing\LazyLoader($this, 'routing.loader.real'), '/Users/ben/Sites/symfonymeeting/app/config/routing_dev.yml', array('cache_dir' => '/Users/ben/Sites/symfonymeeting/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_base_class' => 'Symfony\\Component\\Routing\\Matcher\\UrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'resource_type' => ''));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/ben/Sites/symfonymeeting/app');
    }
    ...
    {
        $this->services['translator.real'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('cache_dir' => '/Users/ben/Sites/symfonymeeting/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => '/Users/ben/Sites/symfonymeeting/app/cache/dev/twig', 'charset' => 'UTF-8'));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/ben/Sites/symfonymeeting/app');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader(array('validation' => 'Symfony\\Component\\Validator\\Constraints\\')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader('loadValidatorMetadata'), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Users/ben/Sites/symfonymeeting/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/DependencyInjection/../../../Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))));
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/ben/Sites/symfonymeeting/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/ben/Sites/symfonymeeting/app/cache/dev',
            'kernel.logs_dir' => '/Users/ben/Sites/symfonymeeting/app/logs',
            ...
            'profiler.storage.file' => '/Users/ben/Sites/symfonymeeting/app/cache/dev/profiler.db',
            ...
            'routing.resource' => '/Users/ben/Sites/symfonymeeting/app/config/routing_dev.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/ben/Sites/symfonymeeting/app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
...
',
            'zend.logger.path' => '/Users/ben/Sites/symfonymeeting/app/logs/dev.log',
            'swiftmailer.class' => 'Swift_Mailer',
            'swiftmailer.transport.sendmail.class' => 'Swift_Transport_SendmailTransport',
            'swiftmailer.transport.mail.class' => 'Swift_Transport_MailTransport',
            'swiftmailer.transport.failover.class' => 'Swift_Transport_FailoverTransport',
            'swiftmailer.init_file' => '/Users/ben/Sites/symfonymeeting/vendor/swiftmailer/lib/swift_init.php',
            'swiftmailer.plugin.redirecting.class' => 'Swift_Plugins_RedirectingPlugin',
            'swiftmailer.plugin.blackhole.class' => 'Swift_Plugins_BlackholePlugin',
            'swiftmailer.base_dir' => '/Users/ben/Sites/symfonymeeting/vendor/swiftmailer/lib',
