...
class __TwigTemplate_cb40e359419fd2f66acd6e7058b5d268 extends Twig_Template
{
    protected $parent;
...
";
        ...
        echo "<span style=\"margin: 0; padding: 0; color: #aaa\">|</span>";
        if ($this->getContext($context, 'profiler_url', '11')) {
            echo "<a style=\"color: #000\" href=\"";
            echo twig_escape_filter($this->env, $this->getContext($context, 'profiler_url', '11'), "html");
            echo "\">";
